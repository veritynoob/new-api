...
export const STATIC_I18N_KEYS = [
  ...
  'Enter the team name',
  'The system or application that will use this API key',
  'The team responsible for this API key',
  'Review and approve API key applications',
  'Are you sure you want to approve this API key?',
  'Are you sure you want to reject this API key?',
  'Enter the reason for rejection...',
  'API Key approved successfully',
  'API Key rejected successfully',
  'Failed to review API key',
